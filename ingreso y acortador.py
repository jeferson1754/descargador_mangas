...
try:
    ...
    try:
        chapter_link = driver.find_element(By.LINK_TEXT, "Capítulo 364.00")
        chapter_link.click()
        print("Capítulo 364.00 encontrado y clickeado.")
    except NoSuchElementException:
        print("No se encontró el enlace al capítulo 364.00.")

    # Intentar hacer clic en el icono del colapsable
    try:
        collapsible_icon = driver.find_element(
            By.CSS_SELECTOR, "#collapsible1138405 .col-2 .fas")
