...
async def remove_ads_and_unnecessary_content(page):
    ...
    await page.evaluate('''() => {
        ...
        // Remove all elements except the manga images and title
        const mangaContainer = document.querySelector('.container-chapter-reader');
        if (mangaContainer) {
...
async def save_as_pdf(url, output_path):
    ...
    await remove_ads_and_unnecessary_content(page)
